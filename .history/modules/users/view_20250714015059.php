...
<head>
    ...
    /* Améliorations mobiles cohérentes avec admin */
...
<body>
    ...
    <script>
        // Animation au chargement - Style Admin
        document.addEventListener('DOMContentLoaded', function() {
            // Animation des valeurs statistiques avec effet de compteur
            ...
            // Animation des stats rapides dans la sidebar
            ...
            // Effet hover amélioré sur les cartes (style admin)
            ...
            const animatedElements = document.querySelectorAll('.permission-item, .quick-stat');
            ...
            // Effet de scintillement sur les badges de rôle
            const roleBadge = document.querySelector('.role-badge');
            if (roleBadge) {
                setTimeout(() => {
                    roleBadge.style.animation = 'pulse 1.5s ease-in-out 2';
                }, 1000);
            }
        });
