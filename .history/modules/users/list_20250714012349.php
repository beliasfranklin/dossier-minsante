...
<body>
    ...
    <div class="container">
        ...
        <?php
        try {
            // Récupérer la liste des utilisateurs avec plus d'informations
            $users = fetchAll("
                SELECT id, external_id, name, prenom, email, role, department, 
                       active, created_at, last_login 
                FROM users 
                ORDER BY name ASC, prenom ASC
            ");
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th><i class="fas fa-calendar"></i> Dernière connexion</th>
                                ...
                                <tr>
                                    <td>
                                        <strong style="color: #2980b9;">
                                            <?= htmlspecialchars($user['external_id'] ?? $user['id']) ?>
                                        </strong>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span style="background: #ecf0f1; color: #2c3e50; padding: 4px 8px; border-radius: 6px; font-size: 0.85rem;">
                                            <?= htmlspecialchars($user['department'] ?? 'Non défini') ?>
                                        </span>
                                    </td>
                                    <td>
                                        <?php 
