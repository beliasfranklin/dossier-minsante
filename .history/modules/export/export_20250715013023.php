...
<div class="main-content">
    <div class="content-header">
        ...
        <div class="header-text">
            <h1>Exporter les dossiers</h1>
            <p>Téléchargez la liste des dossiers dans le format de votre choix</p>
        </div>
    </div>
    ...
    <div class="export-container">
        <div class="export-card animate-fade-in">
            <div class="export-options">
                <h3><i class="fas fa-file-export"></i> Formats disponibles</h3>
                <p class="export-description">
                    Choisissez le format d'export souhaité. L'export prendra en compte 
                    les filtres appliqués sur la liste des dossiers.
                </p>
                
                <div class="format-buttons">
                    <a href="?format=csv" class="format-btn csv-btn">
                    ...
                    <a href="?format=excel" class="format-btn excel-btn">
                        <div class="format-icon">
                            <i class="fas fa-file-excel"></i>
                        </div>
                        <div class="format-info">
                            <h4>Export Excel</h4>
                            <p>Fichier Excel natif (.xlsx)</p>
                        </div>
                    </a>
                    
                    <a href="?format=pdf" class="format-btn pdf-btn">
                        <div class="format-icon">
                            <i class="fas fa-file-pdf"></i>
                        </div>
                        <div class="format-info">
                            <h4>Export PDF</h4>
                            <p>Document PDF formaté</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="export-info">
                    <div class="info-item">
                        ...
                        <span>Les filtres appliqués seront pris en compte</span>
                    </div>
                    <div class="info-item">
                        <i class="fas fa-clock"></i>
                        <span>Export en temps réel</span>
                    </div>
                    <div class="info-item">
