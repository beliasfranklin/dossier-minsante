    ...
    <style>
        ...
        * {
        ...
        .results-title {
            ...
            align-items: center;
            gap: 10px;
            color: #ffffff; /* Ensures text is visible on darker backgrounds */
            font-size: 1.2rem;
            font-weight: 600;
            margin: 0;
        }
        ...
        .results-count {
            color: #e0e0e0; /* Slightly lighter for better readability */
            font-size: 0.9rem;
        }
        ...
        .modern-table td {
            ...
            color: #f5f5f5; /* Lighter text for better visibility */
            font-size: 0.9rem;
            font-weight: 500;
