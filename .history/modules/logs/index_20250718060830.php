...
<head>
    ...
    <style>
        ...
        * {
        ...
        .modern-table th {
    background: rgba(255, 255, 255, 0.3);
    color: #4B2991; /* Violet foncé pour contraste */
    font-weight: 700;
    padding: 15px 20px;
    text-align: left;
    position: sticky;
...
.modern-table td {
    ...
    border-bottom: 1px solid rgba(255, 255, 255, 0.2);
    vertical-align: middle;
    color: #22223B; /* Bleu nuit pour une meilleure lisibilité */
    font-size: 0.95rem;
    font-weight: 500;
    text-shadow: none; /* Retire l'effet flou */
}

.user-name {
    color: #22223B; /* Bleu nuit */
    font-weight: 600;
    font-size: 0.9rem;
}
