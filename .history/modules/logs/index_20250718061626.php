    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            color: #f5f5f5; /* Changed to a lighter shade for better visibility */
            line-height: 1.6;
        }
        ...
        .results-title {
            ...
            align-items: center;
            gap: 10px;
            color: #333333; /* Changed to darker text for better contrast */
            font-size: 1.2rem;
            font-weight: 600;
            margin: 0;
        }
            ...
            <table class="modern-table">
                ...
                <tbody>
                    <?php foreach ($logs as $log): ?>
                        <tr>
                            <td>
                                <span style="color: rgba(6, 6, 6, 0.9); font-size: 0.9rem;">
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <span style="color: rgba(6, 6, 6, 0.9);">-</span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <span style="color: rgba(6, 6, 6, 0.9);">
                                    <?= htmlspecialchars($log['details']) ?>
                                </span>
                            </td>
                            <td>
                                <span style="color: rgba(6, 6, 6, 0.9; font-family: monospace; font-size: 0.8rem;">
