    ...
    <div class="dossiers-grid" id="grid-view">
        ...
        <div class="dossier-card" data-id="<?= $dossier['id'] ?>">
            <div class="card-header">
                ...
                <div class="card-priority priority-<?= $dossier['priority'] ?? 'medium' ?>">
                    <i class="fas fa-flag"></i>
                    <?= ucfirst($dossier['priority'] ?? 'Medium') ?>
                </div>
            </div>
            ...
            <div class="card-footer">
                ...
                <div class="actions-section">
                    <a href="view.php?id=<?= $dossier['id'] ?>" class="action-btn view-btn-action" title="Voir le dossier">
                        <i class="fas fa-eye"></i>
                    </a>
