<?php
// Inclusion sécurisée des dépendances principales pour le header
...
if (!function_exists('t')) {
    if (file_exists(__DIR__ . '/language_manager.php')) {
        require_once __DIR__ . '/language_manager.php';
    } elseif (file_exists(__DIR__ . '/../lang/language.php')) {
        require_once __DIR__ . '/../lang/language.php';
    }
}

// 6. Notifications (après que toutes les dépendances soient chargées)
require_once __DIR__ . '/notifications.php';

// Définir des valeurs par défaut si les fonctions ne sont pas disponibles
if (!function_exists('t')) {
...
if (!function_exists('langUrl')) {
    function langUrl($uri, $lang) {
        return $uri . (strpos($uri, '?') !== false ? '&' : '?') . 'lang=' . $lang;
    }
}
...
// Définir les constantes de rôles si elles n'existent pas
if (!defined('ROLE_ADMIN')) define('ROLE_ADMIN', 'admin');
if (!defined('ROLE_GESTIONNAIRE')) define('ROLE_GESTIONNAIRE', 'gestionnaire');

/**
 * En-tête commune de l'application
 */
if (!isset($pageTitle)) {
    $pageTitle = t('app_name_short', 'MinSanté') . ' - ' . t('app_subtitle', 'Gestion des Dossiers');
}
...
<head>
    ...
    .dropdown-menu.gestion-menu li a {
        color: #34495e; /* Gris foncé pour la gestion */
    }
    ...
    .dropdown-menu.aide-menu li a {
        color: #f39c12; /* Orange pour l'aide */
    }
        ...
        <div class="container">
            ...
            <nav class="main-nav">
                <ul id="mainNavList">
                    ...
                    <!-- Recherche globale -->
                    <li><a href="<?= BASE_URL ?>modules/search/index.php" class="nav-link"><i class="fa-solid fa-search"></i> <?= t('search') ?></a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu gestion-menu">
                            ...
                            <li><a href="<?= BASE_URL ?>modules/workflow/dashboard.php"><i class="fas fa-project-diagram"></i> Workflow</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu rapports-menu">
                            ...
                            <li><a href="<?= BASE_URL ?>modules/analytics/dashboard.php"><i class="fas fa-chart-bar"></i> Analytics</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu aide-menu">
                            ...
                            <li><a href="<?= BASE_URL ?>modules/support/index.php"><i class="fas fa-headset"></i> Support Technique</a></li>
                    ...
                    <li class="notification-menu">
                        <a href="#" id="notificationBell">
                            ...
                            $unreadNotifications = [];
                            $unreadCount = 0;
                            if (function_exists('getUnreadNotifications') && isset($_SESSION['user_id'])) {
                                try {
