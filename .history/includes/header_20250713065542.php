        ...
        <div class="container">
            ...
            <nav class="main-nav">
                <ul id="mainNavList">
                    ...
                    <li class="dropdown">
                        <a href="#" class="nav-link dropdown-toggle">
                            <i class="fa-solid fa-exchange-alt"></i> Statuts
                            <i class="fas fa-chevron-down"></i>
                        </a>
                    ...
                    <li><a href="<?= BASE_URL ?>admin.php" class="nav-link"><i class="fa-solid fa-cog"></i> Administration</a></li>
                    <?php endif; ?>

                    <li><a href="<?= BASE_URL ?>logout.php" class="logout-link nav-link" onclick="return confirm('<?= t('confirm_logout') ?>');"><i class="fa-solid fa-right-from-bracket"></i> Déconnexion</a></li>
                </ul>
            </nav>
        </div>
    </header>
