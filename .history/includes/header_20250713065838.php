                ...
                <ul id="mainNavList">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu modules-menu">
                            ...
                            <li><a href="<?= BASE_URL ?>modules/reporting/stats.php"><i class="fa-solid fa-chart-column"></i> Rapports</a></li>
                            <li><a href="<?= BASE_URL ?>modules/messagerie/list.php"><i class="fa-solid fa-comments"></i> Communication</a></li>
                        </ul>
                    </li>
