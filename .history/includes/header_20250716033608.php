...
<head>
    ...
    /* === VARIABLES CSS DASHBOARD STYLE === */
    :root {
        /* Couleurs principales cohérentes avec dashboard */
        --primary-50: #eff6ff;
        --primary-100: #dbeafe;
        --primary-200: #bfdbfe;
        --primary-300: #93c5fd;
        ...
        <div class="container">
            ...
            <nav class="main-nav">
                <ul id="mainNavList">
                    ...
                    <!-- Recherche globale -->
                    <li><a href="<?= BASE_URL ?>modules/search/index.php" class="nav-link"><i class="fa-solid fa-magnifying-glass"></i> <?= t('search') ?></a></li>
