    ...
    <header class="app-header">
        <div class="container">
            ...
            <nav class="main-nav">
                <ul id="mainNavList">
                    <!-- Dashboard -->
                    <li><a href="<?= BASE_URL ?>dashboard.php" class="nav-link" title="Dashboard"><i class="fa-solid fa-gauge"></i></a></li>

                    <!-- Dossiers -->
                    <li class="dropdown">
                        <a href="#" class="nav-link dropdown-toggle" title="Dossiers">
                            <i class="fa-solid fa-folder-open"></i> Dossiers <i class="fas fa-chevron-down"></i>
                        </a>
                        <ul class="dropdown-menu dossiers-menu">
                            <li><a href="<?= BASE_URL ?>modules/dossiers/list.php"><i class="fas fa-list"></i> Liste</a></li>
                            <li><a href="<?= BASE_URL ?>modules/dossiers/create.php"><i class="fas fa-plus"></i> Nouveau</a></li>
                            <li><a href="<?= BASE_URL ?>modules/archivage/list.php"><i class="fas fa-archive"></i> Archives</a></li>
                        </ul>
                    </li>

                    <!-- Utilisateurs -->
                    <li class="dropdown">
                        <a href="#" class="nav-link dropdown-toggle" title="Utilisateurs">
                            <i class="fa-solid fa-users"></i> Utilisateurs <i class="fas fa-chevron-down"></i>
                        </a>
                        <ul class="dropdown-menu users-menu">
                            <li><a href="<?= BASE_URL ?>modules/users/list.php"><i class="fas fa-list"></i> Liste</a></li>
                            <li><a href="<?= BASE_URL ?>modules/users/create.php"><i class="fas fa-user-plus"></i> Nouveau</a></li>
                            <li><a href="<?= BASE_URL ?>modules/users/profile.php"><i class="fas fa-user"></i> Profil</a></li>
                        </ul>
                    </li>

                    <!-- Catégories -->
                    <li class="dropdown">
                        <a href="#" class="nav-link dropdown-toggle" title="Catégories">
                            <i class="fa-solid fa-tags"></i> Catégories <i class="fas fa-chevron-down"></i>
                        </a>
                        <ul class="dropdown-menu categories-menu">
                            <li><a href="<?= BASE_URL ?>modules/categories/index.php"><i class="fas fa-list"></i> Liste</a></li>
                            <li><a href="<?= BASE_URL ?>modules/categories/create.php"><i class="fas fa-plus"></i> Nouvelle</a></li>
                        </ul>
                    </li>

                    <!-- Statuts -->
                    <li class="dropdown">
                        <a href="#" class="nav-link dropdown-toggle" title="Statuts">
                            <i class="fa-solid fa-exchange-alt"></i> Statuts <i class="fas fa-chevron-down"></i>
                        </a>
                        <ul class="dropdown-menu statuts-menu">
                            <li><a href="<?= BASE_URL ?>modules/statuts/list.php"><i class="fas fa-list"></i> Liste</a></li>
                            <li><a href="<?= BASE_URL ?>modules/statuts/transitions.php"><i class="fas fa-random"></i> Transitions</a></li>
                        </ul>
                    </li>

                    <!-- Logs -->
                    <li class="dropdown">
                        <a href="#" class="nav-link dropdown-toggle" title="Logs">
                            <i class="fa-solid fa-history"></i> Logs <i class="fas fa-chevron-down"></i>
                        </a>
                        <ul class="dropdown-menu logs-menu">
                            <li><a href="<?= BASE_URL ?>modules/logs/index.php"><i class="fas fa-list"></i> Journal</a></li>
                        </ul>
                    </li>

                    <!-- Export -->
                    <li class="dropdown">
                        <a href="#" class="nav-link dropdown-toggle" title="Export">
                            <i class="fa-solid fa-file-export"></i> Export <i class="fas fa-chevron-down"></i>
                        </a>
                        <ul class="dropdown-menu export-menu">
                            <li><a href="<?= BASE_URL ?>modules/export/export.php"><i class="fas fa-file-export"></i> Exporter</a></li>
                        </ul>
                    </li>

                    <!-- Rapports -->
                    <li class="dropdown">
                        <a href="#" class="nav-link dropdown-toggle" title="Rapports">
                            <i class="fa-solid fa-chart-column"></i> Rapports <i class="fas fa-chevron-down"></i>
                        </a>
                        <ul class="dropdown-menu rapports-menu">
                            <li><a href="<?= BASE_URL ?>modules/reporting/stats.php"><i class="fas fa-chart-pie"></i> Statistiques</a></li>
                            <li><a href="<?= BASE_URL ?>modules/reporting/advanced.php"><i class="fas fa-chart-line"></i> Avancés</a></li>
                        </ul>
                    </li>

                    <!-- Communication -->
                    <li class="dropdown">
                        <a href="#" class="nav-link dropdown-toggle" title="Communication">
                            <i class="fa-solid fa-comments"></i> Communication <i class="fas fa-chevron-down"></i>
                        </a>
                        <ul class="dropdown-menu communication-menu">
                            <li><a href="<?= BASE_URL ?>modules/messagerie/list.php"><i class="fas fa-envelope"></i> Messagerie</a></li>
                            <li><a href="<?= BASE_URL ?>modules/notifications/list.php"><i class="fas fa-bell"></i> Notifications</a></li>
                        </ul>
                    </li>
                    ...
                    <!-- Profil -->
                    <li><a href="<?= BASE_URL ?>modules/users/profile.php" class="nav-link" title="Profil"><i class="fa-solid fa-user"></i></a></li>
                    ...
                    <li><a href="<?= BASE_URL ?>admin.php" class="nav-link" title="Administration"><i class="fa-solid fa-cog"></i></a></li>
                    <?php endif; ?>

                    <!-- Déconnexion -->
                    <li><a href="<?= BASE_URL ?>logout.php" class="logout-link nav-link" title="Déconnexion" onclick="return confirm('<?= t('confirm_logout') ?>');"><i class="fa-solid fa-right-from-bracket"></i></a></li>
                </ul>
            </nav>
        </div>
    </header>
