...
if (!defined('DB_HOST')) {
    ...
    if (file_exists($config_file)) {
        ...
        die("Erreur: Le fichier de configuration config.php est introuvable. Vérifiez que le fichier includes/config.php existe.");
    }
}
...
// Fonction getDB() pour retourner l'instance PDO
function getDB() {
    global $pdo;
    return $pdo;
}
