...
// S'assurer que les constantes de configuration sont disponibles
if (!defined('BASE_URL')) {
...
// S'assurer que les fonctions de base de données sont disponibles
if (!function_exists('fetchAll')) {
    require_once __DIR__ . '/db.php';
}

// S'assurer que les fonctions utilitaires sont disponibles
if (!function_exists('time_ago')) {
    require_once __DIR__ . '/functions.php';
}

// S'assurer que les dépendances principales sont disponibles
if (!function_exists('hasPermission')) {
    require_once __DIR__ . '/auth.php';
}

// S'assurer que les fonctions de langue sont disponibles
