...
if (!defined('APP_NAME')) define('APP_NAME', 'Système de Gestion des Dossiers - MINSANTE');
if (!defined('APP_VERSION')) define('APP_VERSION', '1.0.0');
if (!defined('BASE_URL')) define('BASE_URL', 'http://localhost/dossier-minsante/');

// Paramètres de base de données
if (!defined('DB_HOST')) define('DB_HOST', 'localhost');
if (!defined('DB_NAME')) define('DB_NAME', 'minsante_dossiers');
if (!defined('DB_USER')) define('DB_USER', 'root');
if (!defined('DB_PASS')) define('DB_PASS', '');

// Paramètres de sécurité
if (!defined('PEPPER')) define('PEPPER', 'votre_pepper_secret');
if (!defined('SESSION_TIMEOUT')) define('SESSION_TIMEOUT', 3600); // 1 heure en secondes

// Niveaux d'accès
if (!defined('ROLE_ADMIN')) define('ROLE_ADMIN', 1);
if (!defined('ROLE_GESTIONNAIRE')) define('ROLE_GESTIONNAIRE', 2);
if (!defined('ROLE_CONSULTANT')) define('ROLE_CONSULTANT', 3);
...
if (!defined('PASSWORD_REQUIRE_NUMBER')) define('PASSWORD_REQUIRE_NUMBER', true);
