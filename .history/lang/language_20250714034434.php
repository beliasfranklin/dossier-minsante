...
// Définir la langue par défaut seulement si pas déjà définie
 ...
 * Note: Cette fonction est maintenant définie dans language_manager.php
 * On vérifie si elle existe déjà pour éviter la redéclaration
 */
