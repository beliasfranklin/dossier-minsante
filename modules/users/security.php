...
try {
    ...
    // S'assurer que $securityInfo contient les clés nécessaires
    if (!$securityInfo) {
        $securityInfo = [];
    }
    
    // Définir des valeurs par défaut pour les clés manquantes
    $securityInfo = array_merge([
        'email' => 'Non défini',
        'created_at' => null,
        'updated_at' => null,
        'last_login' => null,
            ...
            <div style="padding: 1.5rem;">
                ...
                <div class="info-item" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #f0f4f8;">
                    <div>
                        ...
                        <small style="color: #7f8c8d;">
                            <?= isset($securityInfo['created_at']) && $securityInfo['created_at'] ? date('d/m/Y à H:i', strtotime($securityInfo['created_at'])) : 'Non défini' ?>
                        </small>
                    </div>
                </div>
                ...
                <div class="info-item" style="display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #f0f4f8;">
                    <div>
                        ...
                        <small style="color: #7f8c8d;">
                            <?= isset($securityInfo['last_login']) && $securityInfo['last_login'] ? date('d/m/Y à H:i', strtotime($securityInfo['last_login'])) : 'Inconnue' ?>
                        </small>
                    </div>
                </div>
